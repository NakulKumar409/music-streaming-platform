  ...
  return (
    <div className="relative w-full h-[280px] sm:h-[420px] flex items-center justify-center">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="absolute w-[250px] sm:w-[380px] h-[250px] sm:h-[380px] rounded-full border border-secondary/10" />
        <div className="absolute w-[200px] sm:w-[300px] h-[200px] sm:h-[300px] rounded-full border border-secondary/20" />
        <div className="absolute w-[150px] sm:w-[220px] h-[150px] sm:h-[220px] rounded-full border border-secondary/30" />
        <div className="absolute w-[250px] sm:w-[380px] h-[250px] sm:h-[380px] rounded-full bg-primary/10 blur-[80px]" />
      </div>
      <motion.div
        initial={{ scale: 0.8, opacity: 0 }}
        animate={{ scale: 1, opacity: 1 }}
        transition={{ duration: 1 }}
        className="relative w-[140px] sm:w-[200px] h-[140px] sm:h-[200px] rounded-full bg-gradient-to-br from-[#1a0e0a] to-black border border-secondary/40 flex items-center justify-center shadow-[0_0_80px_rgba(232,93,44,0.5),inset_0_0_60px_rgba(232,93,44,0.2)]">
        <Music2
          className="w-14 sm:w-20 h-14 sm:h-20 text-primary"
          strokeWidth={2.5}
        />
      </motion.div>
    </div>
...
function FeatureTile({
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      transition={{ duration: 0.5 }}
      className="bg-surface border border-white/5 p-4 sm:p-6 rounded-2xl text-center hover:border-secondary/20 transition-colors">
      <div className="h-12 w-12 sm:h-14 sm:w-14 mx-auto bg-secondary/10 border border-secondary/15 rounded-xl flex items-center justify-center mb-3 sm:mb-4">
...
function StatItem({
  ...
  return (
    <div className="flex items-center gap-2 sm:gap-3 px-2 sm:px-3 py-2">
      <div className="h-9 w-9 sm:h-11 sm:w-11 rounded-full bg-secondary/10 border border-secondary/15 flex items-center justify-center shrink-0">
...
function FeatureRow({
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      transition={{ duration: 0.5 }}
      className="flex items-center gap-3 sm:gap-4 rounded-2xl border border-white/5 bg-surface/70 backdrop-blur-sm px-3 sm:px-4 py-3 sm:py-3.5 hover:border-secondary/25 transition-colors">
      <div className="h-10 w-10 sm:h-12 sm:w-12 rounded-xl bg-secondary/10 border border-secondary/20 flex items-center justify-center shrink-0">
        <Icon className="w-5 h-5 sm:w-6 sm:h-6 text-primary" />
      </div>
      <div>
...
export default function ArtistLandingPage() {
    ...
    () =>
      ({
        backgroundImage: `
          ...
          linear-gradient(to bottom, var(--color-bg) 0%, var(--color-bg) 100%)
        `,
      } as const),
    []
  );
  ...
  return (
    <div
      className="min-h-screen w-full bg-background text-white overflow-x-hidden font-sans"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 sm:h-20 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-3 sm:gap-4">
            <a
              ...
              className="hidden sm:flex items-center gap-2 h-9 sm:h-10 px-4 sm:px-5 rounded-full border border-secondary/30 bg-secondary/10 text-[13px] sm:text-[14px] font-medium text-[#e8a87c] hover:bg-secondary/20 transition-all">
      ...
      <section className="px-4 sm:px-6 lg:px-8 pt-12 sm:pt-16 pb-16 sm:pb-24">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
          <div className="text-left">
            ...
            {/* Fan banner */}
            <div className="mt-8 sm:mt-10 rounded-2xl border border-secondary/15 bg-[#1a0e0a]/40 px-4 sm:px-5 py-4 flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4">
              <div className="flex items-center gap-3 w-full sm:w-auto">
                <div className="h-10 w-10 sm:h-11 sm:w-11 rounded-xl bg-[#6a352c]/30 border border-secondary/20 flex items-center justify-center shrink-0">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full sm:w-auto h-9 sm:h-10 px-5 sm:px-6 rounded-full bg-gradient-to-b from-primary to-[#a3441e] flex items-center justify-center text-[12px] sm:text-[14px] font-semibold text-white hover:-translate-y-0.5 transition-transform">
                Open Fan App
              </a>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10 sm:mb-14">
            <motion.h2
              ...
              to <span className="text-primary">build</span> your career
            </motion.h2>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="grid grid-cols-2 md:grid-cols-4 gap-3 rounded-2xl border border-white/5 bg-surface/60 p-3 sm:p-5">
          ...
          <motion.div
            ...
            <Link
              to="/artist/signup"
              className="inline-flex h-12 sm:h-14 px-8 sm:px-10 rounded-full bg-gradient-to-b from-primary to-[#a3441e] items-center text-[15px] sm:text-[16px] font-semibold text-white shadow-[0_10px_30px_rgba(232,93,44,0.35)] hover:-translate-y-0.5 transition-all">
              Create Artist Account
            </Link>
          </motion.div>
        </div>
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden bg-black">
        <div className="absolute top-1/2 right-1/4 w-[700px] h-[700px] bg-primary/10 blur-[140px] rounded-full pointer-events-none" />
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 items-center mb-12 sm:mb-20">
            <div>
              ...
              <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white tracking-tight leading-[1.02]">
                We're with you <br />
                <span className="text-primary">every</span> step.
              </h2>
            </div>
                    ...
                    <div
                      ...
                      <div
                        ...
                        style={{
                          ...
                          background:
                            "linear-gradient(180deg, var(--color-primary) 0%, #7d3b20 100%)",
                          boxShadow:
                            "0 0 25px var(--color-primary), 0 0 50px rgba(232,93,44,0.6)",
                        }}
                      />
                      <div
                        className="absolute"
                        ...
                        <div className="w-10 h-10 rounded-full bg-black border-2 border-primary flex items-center justify-center text-[14px] font-bold text-white shadow-[0_0_25px_rgba(232,93,44,0.9)]">
                          {i + 1}
                        </div>
                      </div>
                    </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 border-t border-white/5 pt-8 sm:pt-10">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5 }}
                className="group bg-surface border border-white/5 rounded-2xl p-5 sm:p-6 hover:border-secondary/30 hover:bg-surface transition-all duration-300 hover:shadow-[0_10px_40px_rgba(232,93,44,0.1)] hover:-translate-y-1">
                <div className="flex items-center gap-3 mb-3 sm:mb-4">
                  ...
                  <div className="h-10 w-10 sm:h-12 sm:w-12 rounded-xl bg-secondary/10 border border-secondary/15 flex items-center justify-center group-hover:bg-secondary/20 group-hover:border-secondary/30 transition-all duration-300">
                    <s.icon className="w-5 h-5 sm:w-6 sm:h-6 text-primary group-hover:scale-110 transition-transform duration-300" />
                  </div>
                </div>

                <h4 className="text-[17px] sm:text-[19px] font-semibold text-white mb-2 group-hover:text-primary transition-colors duration-300">
                  {s.title}
                </h4>
                ...
                <div className="mt-3 h-0.5 w-0 group-hover:w-full bg-gradient-to-r from-primary to-transparent transition-all duration-500 rounded-full" />
              </motion.div>
            ))}
          </div>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="mt-10 sm:mt-14 rounded-2xl border border-secondary/15 bg-gradient-to-r from-[#1a0e0a] to-surface p-4 sm:p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
            <h3 className="text-xl sm:text-2xl font-bold text-white text-center sm:text-left">
              Start your music journey today.
            </h3>
            <Link
              to="/artist/signup"
              className="w-full sm:w-auto h-11 sm:h-12 px-6 sm:px-9 rounded-full bg-gradient-to-b from-primary to-[#a3441e] flex items-center justify-center text-[14px] sm:text-[15px] font-semibold text-white hover:-translate-y-0.5 transition-transform">
              Create Artist Account
            </Link>
          </motion.div>
        </div>
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-black/40 border-y border-white/5">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-6 sm:mb-8">
              <Link
                to="/artist/signup"
                className="w-full sm:w-auto h-12 sm:h-14 px-6 sm:px-9 rounded-full bg-gradient-to-b from-primary to-[#a3441e] flex items-center justify-center text-[15px] sm:text-[16px] font-semibold text-white shadow-[0_10px_30px_rgba(232,93,44,0.35)] hover:-translate-y-0.5 transition-all">
                Create Artist Account
              </Link>
              <Link
                to="/artist/login"
          ...
          <motion.div
            ...
            <div className="p-3 sm:p-5 grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3">
              {[
                ...
                <div
                  key={s.label}
                  className="rounded-lg bg-surface border border-white/5 p-2 sm:p-3">
              ...
              <div className="space-y-1.5 sm:space-y-2">
                {[
                  ...
                  <div
                    ...
                    <div className="h-6 w-6 sm:h-7 sm:w-7 rounded bg-secondary/15 flex items-center justify-center">
                      <Music2 className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-primary" />
                    </div>
                    ...
                    <div className="flex-1 h-1 sm:h-1.5 rounded-full bg-white/5 overflow-hidden">
                      <div
                        className="h-full bg-gradient-to-r from-primary to-[#a3441e]"
                        style={{ width: `${t.w}%` }}
                      />
                    </div>
        ...
        {/* New here banner */}
        <div className="max-w-7xl mx-auto mt-8 sm:mt-10 rounded-2xl border border-white/5 bg-surface/60 px-4 sm:px-5 py-3.5 sm:py-4 flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4">
          <div className="flex items-center gap-3 w-full sm:w-auto">
            <div className="h-10 w-10 sm:h-11 sm:w-11 rounded-full bg-secondary/15 flex items-center justify-center shrink-0">
          ...
          <Link
            to="/artist/signup"
            className="w-full sm:w-auto h-9 sm:h-11 px-5 sm:px-7 rounded-full bg-gradient-to-b from-primary to-[#a3441e] flex items-center justify-center text-[12px] sm:text-[14px] font-semibold text-white">
            Create Account
          </Link>
        </div>
      </section>
      ...
      <section className="relative py-16 sm:py-24 px-4 sm:px-6 lg:px-8 overflow-hidden bg-black">
        ...
        <div className="relative max-w-6xl mx-auto grid lg:grid-cols-2 gap-8 sm:gap-10 items-center">
          ...
          <motion.div
            ...
            <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white tracking-tight leading-[1.02] mb-3 sm:mb-5">
              Your Sound. <br />
              <span className="text-primary">Limitless</span> Reach.
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
              <Link
                to="/artist/signup"
                className="w-full sm:w-auto h-12 sm:h-14 px-6 sm:px-9 rounded-full bg-gradient-to-b from-primary to-[#a3441e] flex items-center justify-center text-[15px] sm:text-[16px] font-semibold text-white shadow-[0_10px_30px_rgba(232,93,44,0.45)] hover:-translate-y-0.5 transition-all">
                Create Artist Account
              </Link>
              <Link
                to="/artist/login"
        ...
        <div className="relative max-w-6xl mx-auto mt-12 sm:mt-20 rounded-2xl border border-secondary/15 bg-[#1a0e0a]/70 backdrop-blur px-4 sm:px-5 py-3.5 sm:py-4 flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4">
          <div className="flex items-center gap-3 w-full sm:w-auto">
            <div className="h-10 w-10 sm:h-11 sm:w-11 rounded-xl bg-[#6a352c]/30 border border-secondary/20 flex items-center justify-center shrink-0">
              <Smartphone className="w-4 h-4 sm:w-5 sm:h-5 text-[#e8a87c]" />
            </div>
